        ...
        <div className="relative">
          ...
          >
              <div className="flex items-center justify-between px-1 mb-2">
                 ...
                 {!isPremium && <span className="text-[8px] font-black text-amber-500 uppercase tracking-widest border border-amber-500/30 px-2 py-0.5 rounded shadow-[0_0_15px_rgba(245,158,11,0.1)]">Requires Creator Tier</span>}
              </div>
